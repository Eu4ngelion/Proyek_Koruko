...
<head>
    ...
    <style>
        body {
            background-color: #000; /* Menambahkan latar belakang hitam */
            color: white; /* Mengubah warna teks menjadi putih */
        }
        .main-content h1 {
            color: white; /* Mengubah warna teks "Kelola Properti" menjadi putih */
        }
    </style>
</head>
                    ...
                    <?php while ($row = mysqli_fetch_assoc($ruko_result)) { ?>
                        <tr>
                            ...
                            <td class="action-buttons">
                                ...
                                <button class="btn-hapus" onclick="deleteProperty(<?php echo $row['id_ruko']; ?>)">Hapus</button>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
